...
ndn::Name file_name;
ndn::ptr_lib::shared_ptr<ndn::KeyChain> key_chain;
ndn::Name certificate_name;
...
int main (int argc, char **argv) {
    ...
    ptr_lib::shared_ptr<ndn::MemoryIdentityStorage> identityStorage(new ndn::MemoryIdentityStorage());
    ptr_lib::shared_ptr<ndn::MemoryPrivateKeyStorage> privateKeyStorage(new ndn::MemoryPrivateKeyStorage());
    key_chain.reset
      (new ndn::KeyChain
    ...
    certificate_name = keyName.getSubName(0, keyName.size() - 1).append("KEY").append
